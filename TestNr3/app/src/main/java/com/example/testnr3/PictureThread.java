...
public class PictureThread extends Thread {
    ...
    private Bitmap sat_bitmap;
    private Canvas canvas;
    private Paint paint;
    private ColorMatrix colorMatrix;
    //    private ColorMatrix colorMatrixCon;
//    private ColorMatrix colorMatrixSat;
    ...
    public PictureThread(ImageView imageView, Bitmap bitmap){
        ...
        sat_bitmap = Bitmap.createBitmap(bitmap.getWidth(), bitmap.getHeight(), bitmap.getConfig());
